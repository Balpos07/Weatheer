    ...
    <ScrollView contentContainerStyle={[styles.container, { backgroundColor: colors.bg }]}>
      ...
      {loading && (
        <View style={styles.loadingContainer}>
          ...
          <Text style={[styles.loadingText, { color: colors.primary }]}>Searching...</Text>
        </View>
      )}
        ...
        <>
          ...
          <View style={styles.actionContainer}>
            ...
            >
              ...
              <Text style={[styles.btnText, { color: colors.primary }]}>Search Another City</Text>
            </TouchableOpacity>
          </View>
        </>
      )}
      ...
      {!loading && !weather && !error && (
        <View style={styles.emptyState}>
          ...
          <Text style={[styles.emptyText, { color: colors.textPrimary }]}>Search for a city</Text>
